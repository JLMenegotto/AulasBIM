...
A função apresenta a treliça no plano XZ, caso prefira trabalhar no plano XY deve alterar linha 20. de 
**PTS = PTI.Translate ( 0 , 0 , altu);** para **PTS = PTI.Translate ( 0 , altu, 0 );**
